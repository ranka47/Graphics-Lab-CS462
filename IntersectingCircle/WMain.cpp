...
char szTitle[] = "Filling Intersecting Circle using Scan Fill Algo";
                    ...
                    LPSTR lpszArgs, int nWinMode)
{
  ...
  hwnd = CreateWindow(
    ...
    CW_USEDEFAULT,
    CW_USEDEFAULT,
    GetSystemMetrics(SM_CXSCREEN), // specific value instead of CW_USEDEFAULT
    GetSystemMetrics(SM_CYSCREEN), // specific value instead of CW_USEDEFAULT
    HWND_DESKTOP,
    NULL,
    hThisInst,
    NULL
